			...
			$.ajax({
    			...
    			success : function(json) {
    				if(json.resultMap.state=='success'){
    					...
    					$("#area").val(json.resultMap.user.area);
    					$("#city").val(json.resultMap.user.city);
    					$("#cardid").val(json.resultMap.user.cardid);
    					$("#type").val(json.resultMap.user.type);
    					$("#score").val(json.resultMap.user.score);
